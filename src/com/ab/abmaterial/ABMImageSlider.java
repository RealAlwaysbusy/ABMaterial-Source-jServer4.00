...
public class ABMImageSlider extends ABMComponent {
	...
	protected String BuildJavaScript() {
		...
		s.append("$('#" + ParentString + ArrayName.toLowerCase() + ID.toLowerCase() + "').abmslider({full_width:" + Theme.FullWidth + ",indicators:" + Theme.Indicators + ",height:" + Theme.Height + ",transition:" + Theme.Transition + ",interval:" + Theme.Interval+ "});");
		return s.toString();
	}
